...
TEST(GenerateCuboid, Basic10x10x10) {
  ...
  ParticleGenerator::cuboid(particles, {0, 0, 0}, size, 1, 0, std::nullopt, std::nullopt, {0, 0, 0});
...
TEST(GenerateCuboid, Mass) {
  ...
  ParticleGenerator::cuboid(particles, {0, 0, 0}, {5, 5, 5}, 1, mass, std::nullopt, std::nullopt, {0, 0, 0});
...
TEST(GenerateCuboid, Velocity) {
  ...
  ParticleGenerator::cuboid(particles, {0, 0, 0}, {5, 5, 5}, 1, 0, std::nullopt, std::nullopt, velocity);
